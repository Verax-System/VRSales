...
async def create_ingredient(
    ...
    return await crud_ingredient.create_ingredient(db=db, ingredient=ingredient_in)
...
async def read_ingredients(
    ...
    return await crud_ingredient.get_ingredients(db)
...
async def update_ingredient_stock(
    ...
    """
    db_ingredient = await crud_ingredient.get_ingredient(db, ingredient_id=ingredient_id)
