...
Revision ID: a14a0db78e0e
Revises: 
Create Date: 2025-10-21 08:48:05.390061
...
def upgrade() -> None:
    ...
    sa.Column('shape', sa.Enum('rectangle', 'round', create_type=False), server_default='rectangle', nullable=False),    sa.Column('rotation', sa.Integer(), server_default='0', nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['store_id'], ['stores.id'], ),
    sa.PrimaryKeyConstraint('id')
